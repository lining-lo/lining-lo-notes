<p align="center">
  <img src=".//images/hero.svg" width="100%" alt="掌柜问数:用自然语言提问,自动生成 SQL,直接返回数据仓库查询结果">
</p>
...
<p align="center">
  <img src=".//images/test-1.png" width="48%" alt="测试一:华北地区销售总额">
  <img src=".//images/test-2.png" width="48%" alt="测试二:2025年各地区平均销售额">
</p>

<p align="center">
  <img src=".//images/test-3.png" width="48%" alt="测试三:各个地区iPhone去年卖了多少钱">
  <img src=".//images/test-4.png" width="48%" alt="测试四:各地区销量排名前三的商品">
</p>
...
<p align="center">
  <img src=".//images/workflow.svg" width="100%" alt="掌柜问数智能体工作流:理解问题、多路召回、过滤增强、生成 SQL、执行返回">
</p>
...
<p align="center">
  <img src=".//images/star-schema.png" width="70%" alt="数据仓库星型模型">
</p>
...
<p align="center">
  <img src=".//images/meta-knowledge.png" width="80%" alt="元数据知识库">
</p>
...
<p align="center">
  <img src=".//images/api-docs.png" width="85%" alt="FastAPI 接口文档">
</p>
