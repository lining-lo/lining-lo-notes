...
学习笔记仓库，模仿 [EveryDay](https://github.com/WindRunnerMax/EveryDay) 的"低摩擦写作 + 自动发布"闭环：只写 Markdown，脚本自动维护目录、统计、时间线，并构建博客发布到 GitHub Pages。

> 学习如春起之苗，不见其增，日有所长；辍学如磨刀之石，不见其损，日有所亏。

- 按学习顺序阅读：[Timeline](./Timeline.md)
- 博客地址：<https://lining-lo.github.io/lining-lo-notes/>
- 使用说明：[USAGE.md](./USAGE.md)

<!-- Summary Start -->
版本库中共有 `100` 篇文章，总计 `129155` 行，`775482` 字，`2246646` 字符。
<!-- Summary End -->
...
* [Vibecoding](大模型/Vibecoding.md)

## 电商小二
* [01_项目全景](电商小二/01_项目全景.md)
...
## 轻客管家
* [01_项目全局](轻客管家/01_项目全局.md)
* [02_环境准备](轻客管家/02_环境准备.md)
* [03_部门管理](轻客管家/03_部门管理.md)
* [04_用户管理](轻客管家/04_用户管理.md)
* [附录-接口文档](轻客管家/附录-接口文档.md)
...
* [附录-图谱的实现](掌柜智库/附录-图谱的实现.md)

## CSS
* [CSS语法](CSS/CSS语法.md)

## Java
* [01_环境和语法](Java/01_环境和语法.md)
* [02_运算符与方法](Java/02_运算符与方法.md)
* [03_流程控制语句](Java/03_流程控制语句.md)
* [04_数组的使用](Java/04_数组的使用.md)
* [05_面相对象编程1](Java/05_面相对象编程1.md)
* [06_面相对象编程2](Java/06_面相对象编程2.md)
* [07_面向对象编程3](Java/07_面向对象编程3.md)
* [08_常用API](Java/08_常用API.md)
* [09_枚举&异常&泛型](Java/09_枚举&异常&泛型.md)
* [10_集合的用法1](Java/10_集合的用法1.md)
* [11_集合的用法2](Java/11_集合的用法2.md)
* [12_文件和IO流](Java/12_文件和IO流.md)
* [13_多线程知识](Java/13_多线程知识.md)
* [14_网络编程知识](Java/14_网络编程知识.md)
* [15_扩展技术](Java/15_扩展技术.md)

## JavaScript
* [Ajax请求](JavaScript/Ajax请求.md)
* [JavaScript语法](JavaScript/JavaScript语法.md)
* [Nodejs语法](JavaScript/Nodejs语法.md)
* [Promise语法](JavaScript/Promise语法.md)
* [TypeScript语法](JavaScript/TypeScript语法.md)
